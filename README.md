<h1>Hurricane Trajectory Prediction</h1>

<h3>How to run code</h3>
<h5>Download data</h5>

```bash
python3 download_HURSAT.py
python3 download_HURDAT2.py
```

<h5>Run CNN on satellite images</h5>

```bash
# if you want to run training on CNN
# python3 train_cnn.py
python3 extract_image_vectors.py
```

<h5>Train Neural ODE</h5>
Each of the following scripts can be run concurrently. Training will take a long time without a GPU. All the training logs will be saved in the `logs` directory.
...
<h5>Parse results</h5>
Parse logs and outputs pandas dataframes with the results.

```bash
python3 parse_logs_sensitivity.py
python3 parse_logs_combined.py
python3 parse_logs_eval_metric.py
```

<h3>Results</h3>

<h5>Testing (sensitivity, solver) pairs</h5>
...
<h5>Testing (sensitivity, forward_solver, backward_solver) triplets</h5>
