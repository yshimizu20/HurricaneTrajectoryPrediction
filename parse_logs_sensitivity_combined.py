...
for file in os.listdir("logs/sensitivity_combined"):
    ...
    forward_solver = file_wo_ext.split("_")[1]
    backward_solver = file_wo_ext.split("_")[2]
    ...
    with open(f"logs/sensitivity_combined/{file}", "r") as f:
        for line in f:
    ...
    results[f"{forward_solver}, {backward_solver}, {sensitivity}"] = {
